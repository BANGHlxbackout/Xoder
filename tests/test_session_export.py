...
from xoder_coding.session_export import export_session_html, render_session_html
...
def test_render_session_html_uses_static_document_layout() -> None:
    ...
    assert '<p class="eyebrow">Xoder session export</p>' in html
...
def test_render_session_html_includes_theme_toggle_script() -> None:
    ...
    assert '"xoder-session-export-theme"' in html
    assert "tau-session-export-theme" not in html
