...
from xoder_coding.oauth_types import OAuthPrompt
from xoder_coding.provider_catalog import builtin_provider_entry
from xoder_coding.tui.app import OAuthLoginScreen
...
async def test_oauth_screen_accepts_blank_provider_prompt() -> None:
    ...
    screen = OAuthLoginScreen(provider, theme=XODER_DARK_THEME)
    screen.compose()
