...
These drive the generic seam on the real ``XoderTuiApp`` via the host bridge,
...
from xoder_coding.tui.app import PromptInput, XoderTuiApp
from xoder_coding.tui.widgets import TranscriptView
