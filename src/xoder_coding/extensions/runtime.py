...
from xoder_agent.events import AgentEvent, AgentStartEvent
...
from xoder_agent.messages import AgentMessage, TextContent
...
from xoder_coding.extensions.loader import (
    LoadedExtension,
    load_extensions,
...
class ExtensionRuntime:
    ...
    def reset_for_reload(self) -> None:
        ...
        parity): any `xoder` API object, context, or ui facade captured before
