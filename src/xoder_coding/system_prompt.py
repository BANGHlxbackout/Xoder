"""System prompt assembly for Xoder coding sessions."""
...
from xoder_coding.self_docs import xoder_docs_path, xoder_examples_path, xoder_readme_path
...
class BuildSystemPromptOptions:
    """Options used to build Xoder's system prompt."""
...
def build_system_prompt(options: BuildSystemPromptOptions) -> str:
    """Build a deterministic Pi-style system prompt for Xoder."""
    ...
    prompt = (
        "You are an expert coding assistant operating inside Xoder, a coding agent harness. "
...
def format_xoder_documentation() -> str:
    """Format Pi-style routing hints to Xoder's installed reference material."""
    readme_path = _format_path(xoder_readme_path())
    docs_path = _format_path(xoder_docs_path())
    examples_path = _format_path(xoder_examples_path())
    return (
        "Xoder documentation (read only when the user asks about Xoder itself, its SDK, "
        ...
        "- When reading Xoder docs or examples, resolve docs/... under Additional docs and "
        ...
        "(docs/tui.md), Xoder architecture and packages (docs/architecture.md)\n"
        "- When working on Xoder topics, read the docs and examples, and follow .md "
        "cross-references before implementing\n"
        "- Always read relevant Xoder .md files completely and follow links to related docs"
    )
