"""Built-in provider catalog for Xoder login/setup flows."""
...
class ProviderCatalogEntry:
    """A built-in provider Xoder can present during login."""
...
def _load_builtin_catalog() -> tuple[ProviderCatalogEntry, ...]:
    ...
    from xoder_coding.catalog_loader import builtin_catalog
