...
Xoder is a minimalist Python coding-agent harness inspired by Pi. Use these installed references when a user asks how to configure, extend, or contribute to Xoder.
...
- [Models](models.md): configure providers and models or change Xoder's built-in catalog.
