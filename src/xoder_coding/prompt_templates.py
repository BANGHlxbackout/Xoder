...
def load_prompt_templates(paths: XoderResourcePaths | None = None) -> list[PromptTemplate]:
    """Load markdown prompt templates from Xoder and `.agents` resource directories."""
