"""Runtime provider construction for Xoder coding sessions."""
...
from xoder_ai.env import AnthropicConfig, RuntimeProviderAuth
...
from xoder_coding.oauth_types import OAuthProvider
...
class ClosableModelProvider(ModelProvider, Protocol):
    """Runtime provider object Xoder owns and can close."""
