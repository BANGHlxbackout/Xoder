...
from xoder_coding.oauth import OpenAICodexOAuthProvider
from xoder_coding.oauth_anthropic import AnthropicOAuthProvider
from xoder_coding.oauth_github_copilot import GitHubCopilotOAuthProvider
...
def oauth_provider_ids() -> frozenset[str]:
    """Return IDs accepted by Xoder's subscription login flow."""
